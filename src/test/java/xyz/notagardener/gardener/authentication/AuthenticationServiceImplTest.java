...
class AuthenticationServiceImplTest {
    ...
    void getGardenerInfo_WhenValidGardenerId_ReturnGardenerInfo() {
        ...
        ActiveGardener activeGardener = new ActiveGardener(gardenerId, name, refreshToken, LocalDateTime.now());
        ...
        // Then
        assertNotNull(result);
        assertEquals(gardener.getGardenerId(), result.getSimpleInfo().getGardenerId());
    ...
    void login_WhenSuccess_ReturnToken() {
        ...
        when(tokenProvider.createRefreshToken(any(), any())).thenReturn(refreshToken);

        Info expectedInfo = Info.from(accessToken.getToken(), refreshToken.getToken(), gardener);
    ...
    void register_WhenValid_ReturnToken() {
        ...
        Info expectedInfo = Info.from(accessToken.getToken(), refreshToken.getToken(), savedGardener);
        ...
        when(tokenProvider.createRefreshToken(savedGardener.getGardenerId(), savedGardener.getName())).thenReturn(refreshToken);
    ...
    void refreshAccessToken_WhenRefreshTokenInvalid_ThrowsBadCredentialsException() {
        ...
        ActiveGardener activeGardener = new ActiveGardener(gardenerId, "메밀", new RefreshToken(), LocalDateTime.now());
    ...
    void refreshAccessToken_WhenRefreshTokenExpired_ThrowsBadCredentialsException() {
        ...
        ActiveGardener activeGardener = new ActiveGardener(gardenerId, "메밀", expiredToken, LocalDateTime.now());
        ...
        BadCredentialsException e = assertThrows(BadCredentialsException.class, executable);
        assertEquals(ExceptionCode.REFRESH_TOKEN_EXPIRED.getCode(), e.getMessage());
    }
