...
public class UserPrincipal implements UserDetails, OAuth2User {
    ...
    public static UserPrincipal create(Gardener gardener, Map<String, Object> oauth2UserAttributes) {
        return new UserPrincipal(gardener.getGardenerId(), gardener.getName(), gardener.getProvider(), oauth2UserAttributes);
    }

    /* 일반 로그인 사용 */
    public static UserPrincipal create(Gardener gardener) {
        return new UserPrincipal(gardener.getGardenerId(), gardener.getName(), gardener.getProvider(), new HashMap<>());
    }
