...
public class ChemicalController {
    ...
    public List<ChemicalDto> getAll(@AuthenticationPrincipal UserPrincipal user) {
        log.debug("chemicalController.getAll");
    ...
    public ChemicalDetail getDetail(@Parameter(description = "약품 id") @PathVariable Long chemicalId, @AuthenticationPrincipal UserPrincipal user) {
