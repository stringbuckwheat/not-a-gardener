...
public class GardenController {
    ...
    public GardenDto.GardenMain garden(@AuthenticationPrincipal UserPrincipal userPrincipal){
        return gardenService.getGarden(userPrincipal.getGardener().getGardenerId());
    }
     ...
     */
    @GetMapping("/plants")
    public List<GardenDto.Response> getPlantsByGardenerId(@AuthenticationPrincipal UserPrincipal userPrincipal){
        return gardenService.getPlantsByGardenerId(userPrincipal.getGardener().getGardenerId());
    }
}
